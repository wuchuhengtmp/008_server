    ...
    <script type="text/javascript">
        ...
        function changeshow(id,status)
        {
            if(id!='')
            {
                $.ajax({
                    type:"POST",
                    url:"/dmooo.php/Banner/changeshow",
                    dataType:"html",
        ...
        <div class="layui-col-md12">
            <div class="layui-card">
                <div class="ibox-title">
                    <h3>当前位置： 内容管理 &raquo; Banner/广告图列表 &raquo; {$cat_title}<a class="pull-right" href="__MODULE__/BannerCat/index">返回上一页 <i class="fa fa-angle-double-right"></i></a></h3>
                </div>
                <div class="ibox-content">
                    <a class="layui-btn pull-right" href="__CONTROLLER__/add/cat_id/{$cat_id}">添加Banner/广告图</a>
                    <div class="layui-row layui-col-space15">
