			...
			<div class="col-sm-12">
				<div class="ibox float-e-margins">
					<div class="ibox-title">
						<h3>当前位置：商品管理 &raquo; 编辑图片<a class="pull-right" href="__CONTROLLER__/index/goods_id/{$msg['goods_id']}/cat_id/{$cat_id}">返回图片列表 <i class="fa fa-angle-double-right"></i></a></h3>
					</div>
				</div>
			</div>
			<div class="row">
                        ...
                        <form action="__ACTION__/goods_img_id/{$msg.goods_img_id}/cat_id/{$cat_id}"  class="form-horizontal" method="post" enctype="multipart/form-data">
                            ...
                            <div class="form-group">
                                <div class="col-sm-4 col-sm-offset-2">
                                    <button class="btn btn-primary" type="submit"><i class="fa fa-check"></i>&nbsp;编辑商品图片</button>
