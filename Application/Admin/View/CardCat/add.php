			...
			<div class="col-sm-12">
				<div class="ibox float-e-margins">
					<div class="ibox-title">
						<h3>当前位置：黑卡管理系统 &raquo; 黑卡分类管理 &raquo; 添加黑卡分类<a class="pull-right" href="__CONTROLLER__/index">返回上一页 <i class="fa fa-angle-double-right"></i></a></h3>
					</div>
				</div>
			</div>
			<div class="row">
                            ...
                            <div class="form-group">
                                ...
                                <div>
                                    <div class="radio i-checks">
                                        <label>
                                        	<input type="radio" name="status" value="Y" checked> <i></i>是
                                        	<input type="radio" name="status" value="N"> <i></i>否
                                        </label>
                                    </div>
                                </div>
                            </div>
