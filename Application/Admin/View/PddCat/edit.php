        ...
        function deloldimg(pdd_cat_id) {
            if (pdd_cat_id != '') {
                swal({
                    ...
                    $.ajax({
                        type: "POST",
                        url: "/dmooo.php/PddCat/deloldimg",
                        dataType: "html",
        ...
        <div class="layui-col-md12">
            <div class="layui-card">
                <div class="ibox-title">
                    <h3>当前位置：拼多多管理系统 &raquo; 拼多多商品分类管理 &raquo; 编辑拼多多商品分类<a class="pull-right"
                                                                           href="__CONTROLLER__/index">返回上一页 <i
            ...
            <div class="layui-col-md12">
                <div class="layui-card">
                    <div class="layui-card-body">
                        <form action="__ACTION__/pdd_cat_id/{$msg['pdd_cat_id']}" class="form-horizontal" method="post"
