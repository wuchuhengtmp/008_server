        ...
        function deloldimg(jingdong_cat_id) {
            if (jingdong_cat_id != '') {
                swal({
                    ...
                    $.ajax({
                        type: "POST",
                        url: "/dmooo.php/JingdongCat/deloldimg",
                        dataType: "html",
        ...
        <div class="layui-col-md12">
            <div class="layui-card">
                <div class="ibox-title">
                    <h3>当前位置：京东管理系统 &raquo; 京东商品分类管理 &raquo; 编辑京东商品分类<a class="pull-right" href="__CONTROLLER__/index">返回上一页
            ...
            <div class="layui-col-md12">
                <div class="layui-card">
                    <div class="layui-card-body">
                        <form action="__ACTION__/jingdong_cat_id/{$msg['jingdong_cat_id']}" class="form-horizontal"
