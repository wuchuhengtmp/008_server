                                            ...
                                            <div class="col-sm-12">
                                                <div class="ibox float-e-margins">
                                                    <div class="ibox-title">
                                                        <h3>当前位置：黑卡管理 &raquo; 修改商品<a class="pull-right" href="__CONTROLLER__/index">返回上一页 <i class="fa fa-angle-double-right"></i></a></h3>
                                                    </div>
                                                </div>
                                            </div>
                                            <div class="row">
                                                                ...
                                                                <div class="tab-content">
                                                                    ...
                                                                    <div id="tab-1" class="tab-pane active" style="padding-top: 10px">
                                                                        ...
                                                                        <div class="form-group">
                                                                            ...
                                                                            <div class="col-sm-10">
                                                                                <input type="text" class="form-control" name="sub_title" value="{$msg['sub_title']}">
                                                                            </div>
                                                                        </div>
                                                                        ...
                                                                        <div class="form-group">
                                                                            ...
                                                                            <div>
                                                                                <div class="radio i-checks">
                                                                                    <label>
                                                                                        <input type="radio" name="status" value="Y" <if condition="$msg['status'] eq 'Y'">checked</if>> <i></i>上架
                                                                                        <input type="radio" name="status" value="N" <if condition="$msg['status'] eq 'N'">checked</if>> <i></i>下架
                                                                                    </label>
                                                                                </div>
                                                                            </div>
                                                                        </div>
                                                                        <div class="form-group">
                                                                            ...
                                                                            <div>
                                                                                <div class="radio i-checks">
                                                                                    <label>
                                                                                        <input type="radio" name="tequan" value="Y" <if condition="$msg['tequan'] eq 'Y'">checked</if>> <i></i>是
                                                                                        <input type="radio" name="tequan" value="N" <if condition="$msg['tequan'] eq 'N'">checked</if>> <i></i>否
                                                                                    </label>
                                                                                </div>
                                                                            </div>
                                                                        </div>
