        ...
        <div class="layui-col-md12">
            <div class="layui-card">
                <div class="ibox-title">
                    <h3>当前位置：管理员管理 &raquo; 权限管理 &raquo; 编辑权限<a class="pull-right" href="__CONTROLLER__/index">返回上一页 <i
            ...
            <div class="layui-col-md12">
                <div class="layui-card">
                    <div class="layui-card-body">
                        <form action="__ACTION__/rule_id/{$msg['id']}" class="form-horizontal" method="post"
                                    ...
                                    <div class="layui-input-block" style="width: 98%;">
                                        <label>
                                            <input type="radio" name="status"
                                                   value="1" <?php if ($msg['status'] == '1') echo 'checked'; ?> >
                                            <i></i>是
                                            <input type="radio" name="status"
                                                   value="0" <?php if ($msg['status'] == '0') echo 'checked'; ?> >
                                            <i></i>否
                                        </label>
                                    </div>
                                </div>
