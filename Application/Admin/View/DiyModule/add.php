        ...
        <div class="layui-col-md12">
            <div class="layui-card">
                <div class="ibox-title">
                    <h3>当前位置：样式DIY设置 &raquo; 功能模块管理 &raquo; 添加模块管理<a class="pull-right" href="__CONTROLLER__/index">返回上一页 <i class="fa fa-angle-double-right"></i></a></h3>
                </div>
            </div>
        </div>
        <div class="layui-row layui-col-space15">
                        ...
                        <form action="__ACTION__"  class="form-horizontal" method="post" enctype="multipart/form-data">
                            <div class="layui-form-item">
                                ...
                                <div class="layui-input-block">
                                    <input type="text" class="layui-input" name="name" placeholder="功能模块名称">
                                </div>
                            </div>
                            <div class="layui-form-item">
                                ...
                                <div>
                                    <div class="layui-input-block">
                                        <label>
                                            <input type="radio" name="is_link" value="Y" checked> <i></i>是
                                            <input type="radio" name="is_link" value="N"> <i></i>否
                                        </label>
                                    </div>
                                </div>
                            </div>
                            <div class="layui-form-item">
                                ...
                                <div class="layui-input-block">
                                    <input type="text" class="layui-input" name="link" placeholder="功能模块链接">
                                </div>
                            </div>
                            <div class="layui-form-item">
                            ...
                            <div class="layui-form-item">
                                ...
                                <div>
                                    <div class="layui-input-block">
                                        <label>
                                            <input type="radio" name="is_index_show" value="Y" checked> <i></i>是
                                            <input type="radio" name="is_index_show" value="N"> <i></i>否
                                        </label>
                                    </div>
                                </div>
                            </div>
