        ...
        function deloldimg(cat_id)
        {
            if(cat_id!=''){
                swal({
                    ...
                    $.ajax({
                        type:"POST",
                        url:'/dmooo.php/ArticleCat/deloldimg',
                        dataType:"html",
                        data:"cat_id="+cat_id,
        ...
        <div class="layui-col-md12">
            <div class="layui-card">
                <div class="ibox-title">
                    <h3>当前位置：内容管理 &raquo; 编辑文章分类<a class="pull-right" href="__CONTROLLER__/index">返回上一页 <i class="fa fa-angle-double-right"></i></a></h3>
                </div>
            </div>
        </div>
        <div class="layui-row layui-col-space15">
