        ...
        <div class="layui-col-md12">
            <div class="layui-card">
                <div class="ibox-title">
                    <h3>当前位置：内容管理 &raquo; 编辑图片<a class="pull-right" href="__CONTROLLER__/Index/article_id/{$msg['article_id']}/cat_id/{$cat_id}">返回图片列表 <i class="fa fa-angle-double-right"></i></a></h3>
                </div>
            </div>
        </div>
        <div class="layui-row layui-col-space15">
