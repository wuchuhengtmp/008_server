...
class InternalPriceServiceClient{
	...
	public static function getService(){
		...
		if (! InternalPriceServiceClient::$isRegis){
			
			InternalPriceServiceClient::regis ();
			InternalPriceServiceClient::$isRegis = true;
		}
		
		
		$ctx = \Osp\Context\InvocationContextFactory::getInstance ();
		$ip = InternalPriceServiceClient::$DEFAULT_PROXY_IP;
		$port = InternalPriceServiceClient::$DEFAULT_PROXY_PORT;	
		try{
		...
		return new \com\vip\xstore\cc\price\InternalPriceServiceHelper();
	}
